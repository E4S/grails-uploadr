...
<h1>5. Initial files, files are added to the top, custom <a href="${resource(plugin:'uploadr', dir:'css', file:'demo.scss')}" target="_new">scss</a>, custom drop text, custom file browse text, paginate to 4 files per page, rating, no sound effects</h1>
